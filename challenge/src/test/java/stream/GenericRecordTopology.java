...
public class GenericRecordTopology implements AutoCloseable {
    ...
    public GenericRecordTopology(
        ...
        final Properties streamsConfiguration = createStreamsConfiguration(bootstrapServers,
                schemaRegistryUrl, applicationId);
    ...
    private Properties createStreamsConfiguration(String bootstrapServers, String schemaRegistryUrl,
                                                  String applicationId) {
